...
const UploadNotes = () => {
  ...
  const addcategory = (e) => {
    ...
    setislaoding(true);
    axios
      .post("https://birthdayrack.vercel.app/api/categories/add", {
        category: category,
        type: formData?.type,
      })
      .then((res) => {
  ...
  const getAllCategories = () => {
    axios
      .get(
        "https://birthdayrack.vercel.app/api/categories/all?page=1&limit=1000"
      )
      .then((res) => {
        console.log(res);
  ...
  const AddQuotes = () => {
    ...
    axios
      .post("https://birthdayrack.vercel.app/api/notes/add", {
        notes: formData?.quote,
