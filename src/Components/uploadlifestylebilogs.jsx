...
const LifeStylebilogs = () => {
  ...
  const addcategory = (e) => {
    ...
    axios
      .post(
        "https://lifestylebilog.vercel.app/api/categories/add",
        {
          category: category,
        }
      )
  ...
  const getAllCategories = () => {
    axios
      .get(
        "https://lifestylebilog.vercel.app/api/categories/all?page=1&limit=1000"
      )
      .then((res) => {
        console.log(res);
  ...
  const AddQuotes = () => {
    ...
    axios
      .post(
        "https://lifestylebilog.vercel.app/api/blogs/add",
        params
      )
      .then((res) => {
        console.log(res);
  ...
  return (
    <div style={{ padding: "2rem" }}>
      <h1> LifeSTyle&Health Blogs Dashboard</h1>
      {/* <section>
        <input
          type="checkbox"
          name="quotecheck"
...
export default LifeStylebilogs;
