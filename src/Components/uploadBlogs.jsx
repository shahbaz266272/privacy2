...
const UploadBlogs = () => {
  ...
  const addcategory = (e) => {
    ...
    axios
      .post(
        "https://bloggingapp.vercel.app/api/categories/add",
        {
          category: category,
        }
      )
  ...
  const getAllCategories = () => {
    axios
      .get(
        "https://bloggingapp.vercel.app/api/categories/all?page=1&limit=1000"
      )
      .then((res) => {
        console.log(res);
  ...
  const AddQuotes = () => {
    ...
    axios
      .post(
        "https://bloggingapp.vercel.app/api/blogs/add",
        params
      )
      .then((res) => {
        console.log(res);
