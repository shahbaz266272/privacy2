...
const UploadDecore = () => {
  ...
  const addcategory = (e) => {
    ...
    axios
      .post(
        "https://hairstyles-rho.vercel.app/api/decorecategory/add",
        {
          category: category,
        }
      )
  ...
  const getAllCategories = () => {
    axios
      .get(
        "https://hairstyles-rho.vercel.app/api/decorecategory/all?page=1&limit=1000"
      )
      .then((res) => {
        console.log(res);
  ...
  const AddQuotes = () => {
    ...
    axios
      .post(
        "https://hairstyles-rho.vercel.app/api/decore/multiple",
        params
      )
      .then((res) => {
        console.log(res);
