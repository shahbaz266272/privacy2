...
const UploadReciepes = () => {
  ...
  const addcategory = (e) => {
    ...
    axios
      .post(
        "https://reciepeapp-five.vercel.app/api/categories/add",
        {
          category: category,
        }
      )
  ...
  const getAllCategories = () => {
    axios
      .get(
        "https://reciepeapp-five.vercel.app/api/categories/all?page=1&limit=1000"
      )
      .then((res) => {
        console.log(res);
  ...
  const AddQuotes = () => {
    ...
    params?.append("reciepeTitle", formData?.reciepetitle);
    params?.append("reciepedescription", formData?.reciepedescription);
    params?.append("categoryName", formData?.category);
    params?.append("file", selectedfile);

    axios
      .post(
        "https://reciepeapp-five.vercel.app/api/reciepe/add",
        params
      )
      .then((res) => {
        console.log(res);
          ...
          <div >
            ...
            <textarea
              ...
              onChange={(e) => {
                ...
                setformData({
                  ...formData,
                  reciepedescription: e?.target?.value,
                });
              }}
            />
            <br></br>
