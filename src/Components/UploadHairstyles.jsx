...
const UploadHairStyles = () => {
  ...
  const addcategory = (e) => {
    ...
    axios
      .post(
        "https://hairstyles-rho.vercel.app/api/categories/add",
        {
          category: category,
        }
      )
  ...
  const getAllCategories = () => {
    axios
      .get(
        "https://hairstyles-rho.vercel.app/api/categories/all?page=1&limit=1000"
      )
      .then((res) => {
        console.log(res);
  ...
  const AddQuotes = () => {
    ...
    axios
      .post(
        "https://hairstyles-rho.vercel.app/api/hairstyle/multiple",
        params
      )
      .then((res) => {
        console.log(res);
...
export default UploadHairStyles;
