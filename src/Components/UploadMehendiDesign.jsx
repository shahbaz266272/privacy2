...
const UploadMehendi = () => {
  ...
  const addcategory = (e) => {
    ...
    axios
      .post(
        "https://mehendistyle.vercel.app/api/categories/add",
        params
      )
      .then((res) => {
        getAllCategories();
  ...
  const getAllCategories = () => {
    axios
      .get(
        "https://mehendistyle.vercel.app/api/categories/all?page=1&limit=1000"
      )
      .then((res) => {
        console.log(res);
  ...
  const AddQuotes = () => {
    ...
    axios
      .post(
        "https://mehendistyle.vercel.app/api/mehendi/multiple",
        params
      )
      .then((res) => {
        console.log(res);
