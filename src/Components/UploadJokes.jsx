...
const UploadJokes = () => {
  ...
  const addcategory = (e) => {
    e?.preventDefault();
     setislaoding(true);
    axios
      .post("https://jokes-iota.vercel.app/api/categories/add", {
        category: category,
       })
      .then((res) => {
        getAllCategories();
  ...
  const getAllCategories = () => {
    axios
      .get(
        "https://jokes-iota.vercel.app/api/categories/all?page=1&limit=1000"
      )
      .then((res) => {
        console.log(res);
  ...
  const AddQuotes = () => {
    ...
    axios
      .post("https://jokes-iota.vercel.app/api/jokes/add", {
        jokes: formData?.quote,
        ...
        <section>
          ...
          <div>
            ...
            {islaoding ? (
              ...
              <input
                disabled={
                  formData?.category === "" || formData?.quote === ""
                }
                type="submit"
                onClick={() => AddQuotes()}
                value="Submit"
