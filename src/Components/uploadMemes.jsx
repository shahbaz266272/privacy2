...
const UploadMemes = () => {
  ...
  const addcategory = (e) => {
    ...
    axios
      .post(
        "https://memesapp-production.up.railway.app/api/categories/add",
        {
          category: category,
        }
      )
  ...
  const getAllCategories = () => {
    axios
      .get(
        "https://memesapp-production.up.railway.app/api/categories/all?page=1&limit=1000"
      )
      .then((res) => {
        console.log(res);
  ...
  const AddQuotes = () => {
    ...
    axios
      .post(
        "https://memesapp-production.up.railway.app/api/memes/multiple",
        params
      )
      .then((res) => {
        console.log(res);
