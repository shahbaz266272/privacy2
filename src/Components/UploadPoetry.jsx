...
const UploadPoetry = () => {
  ...
  const addcategory = (e) => {
    ...
    setislaoding(true);
    axios
      .post("https://apppoetry.vercel.app/api/categories/add", {
        category: category,
        type: formData?.type,
      })
      .then((res) => {
  ...
  const getAllCategories = () => {
    axios
      .get(
        "https://apppoetry.vercel.app/api/categories/all?page=1&limit=1000"
      )
      .then((res) => {
        console.log(res);
  ...
  const AddQuotes = () => {
    ...
    axios
      .post("https://apppoetry.vercel.app/api/poetry/add", {
        poetry: formData?.quote,
